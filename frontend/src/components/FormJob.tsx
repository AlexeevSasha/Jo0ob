...
export const FormJob: FC<IProps> = ({title, onFinish, defaultValue}) => {
    return (
        <Wrapper>
            <h2>{title}</h2>
            <Form
            ...
            >
                ...
                <Form.Item
                    ...
                    rules={[{required: true, message: 'Please input position!'},{max: 30, message: 'Maximum 3 characters!'}]}
                >
                    <Input/>
                </Form.Item>
                ...
                <Form.Item
                    ...
                    rules={[{required: true, message: 'Please input company!'},{max: 30, message: 'Maximum 3 characters!'}]}
                >
                    <Input/>
                </Form.Item>
                ...
                <Form.Item label="Status" name='status' initialValue={defaultValue?.status ? defaultValue.status : statusOption[0].value}>
                    <Select >
                ...
                <Form.Item label="Type" name='type' initialValue={defaultValue?.type ? defaultValue.type  : jobType[0].value}>
                    <Select>
